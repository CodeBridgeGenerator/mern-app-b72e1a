...
updatedBy: _entity?.updatedBy,
        ...
        const result = await client.service("errorsMenaka").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info errorsMenaka updated successfully" });
    ...
    return (
        <Dialog header="Edit ErrorsMenaka" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="errorsMenaka-edit-dialog-component">
