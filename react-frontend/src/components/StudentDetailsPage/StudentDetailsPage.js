...
const StudentDetailsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , courseName : urlParams.singleCourseDetailsId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
    ...
    const service = _.find(config.services, { serviceName : "studentDetails"});
