...
createdBy: _entity?.createdBy,
    ...
    return (
        <Dialog header="Edit Audits" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
