...
const ErrorsMenakaPage = (props) => {
    ...
    useEffect(() => {
        const _getSchema = async () => {
            const _schema = await props.getSchema("errorsMenaka");
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="errorsMenaka-add-button"/>
                    
                    </>
                </div>
            </div>
            <div className="grid align-items-center">
                <div className="col-11" role="errorsMenaka-datatable">
...
/>            
      ...
      />
            ...
            <ErrorsMenakaCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
