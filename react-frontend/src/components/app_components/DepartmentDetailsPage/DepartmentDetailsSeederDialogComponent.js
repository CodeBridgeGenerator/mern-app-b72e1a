...
import seederData from "./departmentDetails.seeder.json";
...
const DepartmentDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DepartmentDetailsSeederDialogComponent);
