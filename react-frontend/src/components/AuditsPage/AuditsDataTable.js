...
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.createdBy}</p>
    ...
    const paginatorRight = DownloadCSV({ data : items, fileName : "audits"});
...
<Column field="method" header="Method" body={pTemplate2} filter={selectedFilterFields.includes("method")} hidden={selectedHideFields?.includes("method")}  sortable style={{ minWidth: "8rem" }} />
